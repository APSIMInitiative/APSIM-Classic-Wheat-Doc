...
\subsection{Thermal time calculation{#par:Thermal-time}}
...
\par\end{centering}
\caption{{#fig:PhenologWheatModule}Phenology in the APSIM\_Wheat module.
...
\subsection{Photoperiod impact on phenology{#subsec:Photoperiod}}
...
Emergence to Floral initiation (Composite phases **eme2ej** in
